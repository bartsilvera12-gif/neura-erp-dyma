    ...
    const html = plantillaFichaCliente(
      {
        ...
        cliente: {
          ...
          dv: (c.dv as string) ?? null,
          profesion: (c.profesion as string) ?? null,
          lugar_trabajo: (c.lugar_trabajo as string) ?? null,
          ...
          conyuge_nombre: (c.conyuge_nombre as string) ?? null,
          conyuge_documento: (c.conyuge_documento as string) ?? null,
          conyuge_profesion: (c.conyuge_profesion as string) ?? null,
          conyuge_lugar_trabajo: (c.conyuge_lugar_trabajo as string) ?? null,
          conyuge_telefono: (c.conyuge_telefono as string) ?? null,
        },
        contratos,
        limpiezas,
      },
