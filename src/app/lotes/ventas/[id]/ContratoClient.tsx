  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6 px-4 pb-10 sm:px-6 lg:px-8">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4">
        <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">Partes del contrato</p>
        <div className="mt-2 flex flex-wrap items-center gap-2 text-sm">
          ...
          {data.codeudores.length === 0 ? <span className="text-xs text-slate-400">Sin codeudores.</span> : null}
        </div>
      </div>
